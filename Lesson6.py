...
for batch_size in batch_sizes:
    for learning_rate in learning_rates:
        ...
        writer = SummaryWriter(f'optimized_runs/MNIST/MiniBatch {batch_size} LR {learning_rate}')
        # Loss and optimizer
        ...
        for epoch in range(epochs):
            ...
            for batch_idx, (data, target) in enumerate(train_loader):
                ...
                writer.add_scalar('Epoch Training Loss', loss, global_step=step)
                writer.add_scalar('Epoch Training Accuracy', running_training_acc, global_step=step)
            ...
            writer.add_scalar('Training Loss', sum(losses), epoch)
